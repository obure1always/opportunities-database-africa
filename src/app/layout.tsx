          ...
          <footer className="bg-gray-900 text-white">
            <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
              <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div>
                  <h3 className="text-lg font-semibold mb-4">About ODA</h3>
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <p className="text-sm font-medium text-white">John Obure</p>
                      <p className="text-sm text-gray-300 mt-1">Founder & CEO</p>
                      <p className="text-gray-400 mt-2">
                        Connecting African students with educational and professional opportunities worldwide.
                      </p>
                    </div>
                  </div>
                </div>
