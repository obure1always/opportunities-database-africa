...
import { FiMail, FiLock, FiUser, FiAlertCircle, FiCheck, FiX } from 'react-icons/fi';
          ...
          >
            <div className="px-8 py-10">
              <div className="text-center mb-8">
                ...
                <p className="text-gray-600">Join our community of scholarship seekers</p>
              </div>
                  ...
                  {formData.password && (
                    <div className="mt-2">
                      <div className="flex items-center justify-between text-sm">
                        ...
                        <span className={`font-medium ${getPasswordStrengthColor(passwordStrength)} text-white px-2 py-1 rounded`}>
